...
if (isset($_POST['submit'])) {
    ...
    $updateSQL = "UPDATE tlb_nhanvien SET ho_ten='" . $ho_ten . "' , gioi_tinh='" . $gioi_tinh . "', dt_di_dong='" . $dt_di_dong . "', email='" . $email . "', ngay_sinh='" . $ngay_sinh . "', dia_chi='" . $dia_chi . "' WHERE ma_nhan_vien='" . $ma_nv . "'";
...
<form method="post" id="form1">
    <table class="row2" width="800" align="center" cellpadding="2" cellspacing="2" bgcolor="#c6edf7" style="padding-left: 200px;">
        ...
        <tr>
            ...
            <td><input type="date" name="ngay_sinh" value="<?php echo $row_RCcapnhat_nhanvien['ngay_sinh']; ?>" size="30" />(dd-mm-yyyy)</td>
        </tr>
        <tr valign="baseline">
