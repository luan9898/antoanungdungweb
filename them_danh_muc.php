...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO $table VALUES (%s, %s, %s)",
  ...
  <tr>
    <td class="row2" width="260" align="center" valign="top">
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table width="255" align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Miêu tả <?php echo $title?> :</td>
            <td><input type="text" name="3" value="" size="24" /></td>
          </tr>
          <tr valign="baseline">
    ...
    <td class="row2" width="500" valign="top"><table width="500" border="0" cellspacing="1" cellpadding="1">
      <tr>
        ...
        <th width="110">Tên <?php echo $title?></th>
        <th width="165">Miêu tả <?php echo $title?></th>
        <th width="35">&nbsp;</th>
        <th width="35">&nbsp;</th>
      </tr>
      <?php 
